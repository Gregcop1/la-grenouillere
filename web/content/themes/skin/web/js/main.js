...
module.exports = ContentBuilder = (function() {
  ...
  ContentBuilder.prototype.showFooter = function() {
    ...
    Velocity(document.querySelector(this.selector.siteContent), {
      ...
      transition: this.transitionDuration.slide,
      easing: 'linear'
    });
    return this;
  };
...
var ContentBuilder, FooterManager, Velocity,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
FooterManager = (function() {
  ...
  FooterManager.prototype.show = function() {
    var footer;
    this.isShown = true;
    footer = document.querySelector(this.selector.footer);
  ...
  FooterManager.prototype.hide = function() {
    Velocity(document.querySelector(this.selector.footer), 'fadeOut', {
      duration: this.isShown ? ContentBuilder.prototype.transitionDuration.fade : 0,
      delay: ContentBuilder.prototype.transitionDuration.fade,
      easing: 'linear',
      complete: (function(_this) {
        return function() {
  ...
  FooterManager.prototype.bind = function() {
    ...
    body.addEventListener(ContentBuilder.prototype.event.FOOTER_HIDE, this.hide);
    body.addEventListener(ContentBuilder.prototype.event.PREVIOUS_ROW, this.hide);
    body.addEventListener(ContentBuilder.prototype.event.NEXT_ROW, this.hide);
    return this;
  };
...
},{"./ContentBuilder.coffee":2,"velocity-animate":1}],4:[function(require,module,exports){
...
},{"./ContentBuilder.coffee":2}],5:[function(require,module,exports){
