...
module.exports = ContentBuilder = (function() {
  ...
  function ContentBuilder(menu, container) {
    ...
    this.goToFooter = bind(this.goToFooter, this);
  ...
  ContentBuilder.prototype.goToFooter = function() {
  ...
  ContentBuilder.prototype.bind = function() {
    ...
    document.body.addEventListener(this.event.NEXT_ARTICLE, this.goToNextArticle);
    document.body.addEventListener(this.event.PREVIOUS_ARTICLE, this.goToPrevArticle);
    document.body.addEventListener(this.event.NEXT_ROW, this.goToNextRow);
    document.body.addEventListener(this.event.PREVIOUS_ROW, this.goToPrevRow);
    document.body.addEventListener(this.event.ARTICLES_LOADED, this.showFirstArticle);
    return this;
  };
...
FooterManager = (function() {
  ...
  FooterManager.prototype.bind = function() {
    document.body.addEventListener(ContentBuilder.prototype.event.FOOTER_SHOW, this.show);
    document.body.addEventListener(ContentBuilder.prototype.event.FOOTER_HIDE, this.hide);
    document.body.addEventListener(ContentBuilder.prototype.event.PREVIOUS_ROW, this.hide);
    document.body.addEventListener(ContentBuilder.prototype.event.NEXT_ROW, this.hide);
    return this;
  };
