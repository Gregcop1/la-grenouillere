...
module.exports = ContentBuilder = (function() {
  ...
  ContentBuilder.prototype.classes = {
    row: 'section-row',
  ...
  ContentBuilder.prototype.loadContent = function(index, link) {
    ...
    XHRT.onload = (function(_this) {
      return function() {
        ...
        return _this.buildArticle(index, response.innerHTML);
      };
    })(this);
  ...
  ContentBuilder.prototype.getCurrentRow = function() {
    var currentRow;
    currentRow = this.container.querySelector('.' + this.classes.currentRow);
    if (!currentRow) {
      currentRow = this.container.querySelector('.' + this.classes.row);
    }
    return currentRow;
  };
  ...
  ContentBuilder.prototype.goToNextRow = function() {
    ...
    if (nextRow) {
      firstArticle = nextRow.querySelector('.' + this.classes.article);
  ...
  ContentBuilder.prototype.goToPrevRow = function() {
    ...
    if (previousRow) {
      firstArticle = previousRow.querySelector('.' + this.classes.article);
      this.goToArticle(firstArticle);
    }
    return this;
  };
  ...
  ContentBuilder.prototype.prepareSwitchOfRow = function(cumulatedDelay) {
    var goTrough;
    goTrough = false;
    [].forEach.call(this.container.querySelectorAll('.' + this.classes.currentRow), (function(_this) {
      return function(node) {
        goTrough = true;
        node.classList.remove(_this.classes.currentRow);
  ...
  ContentBuilder.prototype.goToRow = function(row, cumulatedDelay) {
    if (!row.classList.contains(this.classes.currentRow)) {
      cumulatedDelay += this.prepareSwitchOfRow(cumulatedDelay);
      row.style.marginLeft = 0;
      row.classList.add(this.classes.currentRow);
      Velocity(row, 'fadeIn', {
  ...
  ContentBuilder.prototype.prepareSwitchOfArticle = function(cumulatedDelay) {
    var goTrough;
    goTrough = false;
    [].forEach.call(this.container.querySelectorAll('.' + this.classes.currentArticle), (function(_this) {
      return function(node) {
        goTrough = true;
        node.classList.remove(_this.classes.currentArticle);
        return Velocity(node.querySelector('.' + _this.classes.articleContent), 'fadeOut', {
          duration: _this.transitionDuration.fade,
          delay: cumulatedDelay
        });
      };
  ...
  ContentBuilder.prototype.goToArticle = function(article) {
    ...
    if (!article.classList.contains(this.classes.currentArticle)) {
      cumulatedDelay = 0;
      cumulatedDelay = this.prepareSwitchOfArticle(cumulatedDelay);
      row = article.closest('.' + this.classes.row);
      cumulatedDelay = this.goToRow(row, cumulatedDelay);
      article.classList.add(this.classes.currentArticle);
      ...
      Velocity(article.querySelector('.' + this.classes.articleContent), 'fadeIn', {
        duration: this.transitionDuration.fade,
        delay: cumulatedDelay
      });
  ...
  ContentBuilder.prototype.getCurrentArticle = function() {
    var currentArticle;
    currentArticle = this.container.querySelector('.' + this.classes.currentArticle);
    if (!currentArticle) {
      currentArticle = this.container.querySelector('.' + this.classes.article);
    }
  ...
  ContentBuilder.prototype.bind = function() {
    ...
    document.body.addEventListener('NEXT_ARTICLE', this.goToNextArticle);
    document.body.addEventListener('PREVIOUS_ARTICLE', this.goToPrevArticle);
    document.body.addEventListener('NEXT_ROW', this.goToNextRow);
    document.body.addEventListener('PREVIOUS_ROW', this.goToPrevRow);
    return this;
  };
...
KeyBoardListener = (function() {
  ...
  KeyBoardListener.prototype.keyDown = function(event) {
    switch (event.keyCode) {
      case 38:
        document.body.dispatchEvent(new Event('PREVIOUS_ROW'));
        break;
      case 40:
        document.body.dispatchEvent(new Event('NEXT_ROW'));
        break;
      case 37:
        document.body.dispatchEvent(new Event('PREVIOUS_ARTICLE'));
        break;
      case 39:
        document.body.dispatchEvent(new Event('NEXT_ARTICLE'));
    }
    return this;
  };
