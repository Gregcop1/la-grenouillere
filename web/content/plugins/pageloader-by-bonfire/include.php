...
<div class="bonfire-pageloader-icon-wrapper<?php if(is_singular() ) { ?> <?php echo $bonfire_pageloader_display; ?><?php } ?><?php if( get_theme_mod('bonfire_pageloader_progressbar_only') != '') { ?> pageloader-hide<?php } ?>">
